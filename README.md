...
- [Home / guide](https://atelierarith.github.io/PythonRNGs.jl/dev/)
- [Reproducibility](https://atelierarith.github.io/PythonRNGs.jl/dev/reproducibility/) —
  exact Python call for each draw, array order, and normal/permutation/shuffle
  behavior.
- [API](https://atelierarith.github.io/PythonRNGs.jl/dev/api/) — backends,
  supported interface, and `NotSupportedError`.
